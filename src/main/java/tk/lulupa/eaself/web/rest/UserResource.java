...
import tk.lulupa.eaself.domain.Authority;
import tk.lulupa.eaself.domain.User;
import tk.lulupa.eaself.repository.AuthorityRepository;
import tk.lulupa.eaself.repository.UserRepository;
import tk.lulupa.eaself.repository.search.UserSearchRepository;
import tk.lulupa.eaself.security.AuthoritiesConstants;
import tk.lulupa.eaself.service.UserService;
import tk.lulupa.eaself.web.rest.dto.ManagedUserDTO;
import tk.lulupa.eaself.web.rest.dto.UserDTO;
import tk.lulupa.eaself.web.rest.util.HeaderUtil;
import tk.lulupa.eaself.web.rest.util.PaginationUtil;
